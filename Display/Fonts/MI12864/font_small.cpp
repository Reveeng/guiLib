...
const unsigned char oled_font_small[] = {
    ...
    0x00, 0x02, 0x05, 0x02, 0x00, 0x00, // °, ASCII 167 (0xA7)
    0x00, 0x55, 0xAA, 0x55, 0xAA, 0x00, // unknown char
};
...
namespace Display{
    namespace MI12864{
        FontData font_small(){
            return FontData(oled_font_small,6,8,97,0x20);
        }
    }
}
